...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/WalletChip.tsx
  var WalletChip_exports = {};
  __export(WalletChip_exports, {
    Collapsed: () => Collapsed,
    Open: () => Open
  });
  init_define_import_meta_env();
  ...
  var Collapsed = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.WalletChip, { address: RECIPIENT, open: false, onToggle: noop, onDisconnect: noop });
  var Open = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { minHeight: 180 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.WalletChip, { address: RECIPIENT, open: true, onToggle: noop, onDisconnect: noop }) });
  return __toCommonJS(WalletChip_exports);
})();
