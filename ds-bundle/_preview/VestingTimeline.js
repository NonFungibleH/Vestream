...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/VestingTimeline.tsx
  var VestingTimeline_exports = {};
  __export(VestingTimeline_exports, {
    Portfolio: () => Portfolio,
  ...
  var STREAMS = [NOVA_STREAM, FLUX_STREAM, KLAR_STREAM, VEST_STREAM];

  // .design-sync/previews/VestingTimeline.tsx
  var import_jsx_runtime = __toESM(require_react_shim());
  var Portfolio = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.VestingTimeline, { streams: STREAMS });
  var WithRecipients = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.VestingTimeline, { streams: STREAMS, showRecipient: true });
  var SingleStream = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.VestingTimeline, { streams: [STREAMS[0]] });
  return __toCommonJS(VestingTimeline_exports);
})();
