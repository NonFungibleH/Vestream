    ...
    <div className="min-h-screen overflow-x-hidden" style={{ background: "#F5F5F3", color: "#1A1D20" }}>
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-5 pt-24 pb-16 md:pt-40 md:pb-32 overflow-hidden">
          ...
          <div style={{ background: "#0d0f14", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", boxShadow: "0 24px 64px rgba(0,0,0,0.45)", width: "210px", padding: "16px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              {([
                ...
                { symbol: "NOVA", pct: 22, color: "#C47A1A" },
        ...
        <div className="absolute hidden xl:block pointer-events-none"
          ...
          <div style={{ background: "#0d0f14", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", boxShadow: "0 24px 64px rgba(0,0,0,0.45)", width: "210px", padding: "16px" }}>
            ...
            {/* Streaming now */}
            <div style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 10px", borderRadius: "10px", background: "rgba(45,138,74,0.08)", border: "1px solid rgba(45,138,74,0.2)", marginBottom: "7px" }}>
              ...
              <div className="rounded-xl p-4" style={{ background: "linear-gradient(135deg,#1A1D20,#0F8A8A 55%,#1CB8B8)", border: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <div className="flex gap-2 mt-3">
                  {[
                    ...
                    { l: "Streams",   v: "4 active", c: "rgba(196,160,74,0.12)"  },
                    { l: "Next",      v: "14d 6h",   c: "rgba(196,160,74,0.15)"  },
                  ].map((s) => (
                ...
                <div className="md:col-span-2 rounded-xl p-3" style={{ background: "#141720", border: "1px solid #1e2330" }}>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      { s: "NOVA", clPct:  8, lkPct: 92, color: "#C47A1A", total: "$45,000"  },
          ...
          <div className="rounded-2xl overflow-hidden" style={{ background: "#0d0f14", border: "1px solid #1e2330", boxShadow: "0 8px 32px rgba(0,0,0,0.18)" }}>
            ...
            <div className="px-4 pb-4 space-y-2">
              {[
                ...
                { sym: "NOVA", price: "$1.84",    mc: "$756M",  liq: "$48M",  color: "#C47A1A" },
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-28 max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="flex-1 w-full rounded-2xl p-5 md:p-6" style={{ background: "#0d0f14", border: "1px solid #1e2330", boxShadow: "0 8px 32px rgba(0,0,0,0.18)" }}>
            ...
            {[
              { protocol: "Sablier",      chain: "Base",       token: "NOVA", amount: "12,500", color: "#C47A1A" },
              ...
              { protocol: "Superfluid",   chain: "Polygon",    token: "VEST", amount: "3,100",  color: "#1F7A64" },
              { protocol: "PinkSale",     chain: "BNB Chain",  token: "FLUX", amount: "5,000",  color: "#B85585" },
            ].map((r) => (
      ...
      <section className="px-4 md:px-8 pb-16 md:pb-28 max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row-reverse items-center gap-10 md:gap-16">
          ...
          <div className="flex-1 md:max-w-[420px]">
            <div className="w-11 h-11 rounded-2xl flex items-center justify-center mb-5"
              style={{ background: "rgba(74,122,130,0.08)", border: "1px solid rgba(74,122,130,0.14)", color: "#4A7A82" }}>
            ...
            {[
              ...
              <div key={w.wallet} className="mb-2.5">
                ...
                <div className="h-1 rounded-full" style={{ background: "#1e2330" }}>
                  <div className="h-1 rounded-full" style={{ width: `${w.pct}%`, background: "linear-gradient(90deg, #4A7A82, #1CB8B8)" }} />
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="rounded-3xl overflow-hidden relative flex flex-col md:flex-row items-center gap-8 md:gap-0 p-8 md:p-12"
          ...
          <div className="relative flex-shrink-0">
            <svg width={150} height={310} viewBox="0 0 150 310" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Portfolio rows */}
              {[
                { y: 178, label: "NOVA", val: "$4,218", color: "#C47A1A" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start mb-12">
          ...
          <div className="relative rounded-2xl p-7" style={{ background: "white", border: "2px solid #1CB8B8", boxShadow: "0 8px 32px rgba(28,184,184,0.18), 0 4px 12px rgba(21,23,26,0.10)" }}>
            ...
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-bold mb-3"
              style={{ background: "rgba(45,138,74,0.1)", border: "1px solid rgba(45,138,74,0.25)", color: "#059669" }}>
              14-day free trial
            </div>
