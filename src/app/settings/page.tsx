...
const ALL_BACKEND_PROTOCOL_IDS = ["sablier", "uncx", "uncx-vm", "hedgey", "unvest", "superfluid", "pinksale", "hoodlock"];
                  ...
                  {pushAlertsLimit !== null ? (
                    <div className="mb-3 px-3 py-2 rounded-lg"
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <p className="text-[11px] font-semibold" style={{ color: pushAlertsSent >= pushAlertsLimit ? "#F0992E" : "#1CB8B8" }}>
                        ...
                        {pushAlertsSent >= pushAlertsLimit && (
                          <a href="/pricing" className="text-[10px] font-semibold underline" style={{ color: "#F0992E" }}>
                            Upgrade →
                          </a>
                        )}
                      </div>
                      <div className="mt-1.5 h-1 rounded-full overflow-hidden"
                        ...
                        <div className="h-full transition-all"
                          style={{
                            ...
                            background: pushAlertsSent >= pushAlertsLimit ? "#F0992E" : "#1CB8B8",
                          }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="mb-3 px-3 py-2 rounded-lg inline-block"
                      style={{ background: "rgba(45,179,106,0.08)", border: "1px solid rgba(45,179,106,0.25)" }}>
