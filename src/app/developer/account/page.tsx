      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
            ...
            <div className="w-full h-2 rounded-full mb-2" style={{ background: "rgba(255,255,255,0.06)" }}>
              <div className="h-2 rounded-full transition-all" style={{
                ...
                background: isNearLimit
                  ? "linear-gradient(90deg, #C47A1A, #B3322E)"
                  : "#1CB8B8",
              }} />
            </div>
            <p className="text-xs mb-2" style={{ color: isNearLimit ? "#C47A1A" : "rgba(255,255,255,0.3)" }}>
              {isNearLimit
        ...
        <div className="rounded-2xl p-6 mb-8"
          ...
          <p className="text-xs mt-3 px-3 py-2 rounded-lg"
            style={{ background: "rgba(245,158,11,0.06)", color: "rgba(196,160,74,0.7)", border: "1px solid rgba(245,158,11,0.12)" }}>
