...
export const metadata: Metadata = {
  ...
  description: "Get early access to Vestream – the free tracker for every token vesting and unlock across 12+ protocols. Sign up in 30 seconds.",
  alternates:  { canonical: "https://www.vestream.io/early-access" },
  openGraph: {
    title:       "Early Access – Vestream Token Vesting Tracker",
    description: "Get early access to Vestream – track every token unlock across 12+ protocols. Free, no credit card.",
