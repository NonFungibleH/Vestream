...
const FAQ_DATA: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Go to /early-access, enter your email, and you'll get a one-time code to sign in. From there you add any wallet — EVM 0x… address or Solana pubkey — and TokenVest automatically scans it across all 9 protocols and 7 chains. Free plan tracks 1 wallet; Pro tracks 3; Enterprise is unlimited.",
      },
      {
      ...
      },
      {
        ...
        a: "No. When you add a wallet address, TokenVest auto-scans all 9 supported protocols across all 7 chains (EVM + Solana) and surfaces every vesting stream found — you don't need to know in advance which platform your tokens are on.",
      },
    ],
  },
  {
