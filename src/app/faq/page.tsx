...
const FAQ_DATA: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "No. When you add a wallet address, Vestream auto-scans all 10 supported protocols across all 8 chains (EVM + Solana) and surfaces every vesting stream found – you don't need to know in advance which platform your tokens are on.",
      },
    ],
  },
  {
