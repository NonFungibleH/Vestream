...
const FAQ_DATA: FaqCategory[] = [
  {
    ...
    items: [
      {
        q: "What is TokenVest?",
        a: "TokenVest is a cross-protocol, cross-chain tracker for on-chain token vesting. It indexes every public vesting schedule from nine major platforms — Sablier, Hedgey, UNCX, Unvest, Team Finance, Superfluid, PinkSale, Streamflow, and Jupiter Lock — across Ethereum, Base, BNB Chain, Polygon, and Solana, and gives you one dashboard to see every unlock coming to any wallet, plus email and push alerts before each one.",
      },
      {
      ...
      },
      {
        ...
        a: "Go to /early-access, enter your email, and you'll get a one-time code to sign in. From there you add any wallet — EVM 0x… address or Solana pubkey — and TokenVest automatically scans it across all 9 protocols and 5 chains. Free plan tracks 1 wallet; Pro tracks 3; Enterprise is unlimited.",
      },
      {
      ...
      },
      {
        ...
        a: "No. When you add a wallet address, TokenVest auto-scans all 9 supported protocols across all 5 chains (EVM + Solana) and surfaces every vesting stream found — you don't need to know in advance which platform your tokens are on.",
      },
    ],
  },
  {
