    ...
    <main className="min-h-screen" style={{ background: THEME.pageBg, color: THEME.navyDeep }}>
      ...
      <section className="relative overflow-hidden pt-24 md:pt-32 pb-16 md:pb-24 px-4 md:px-8">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 50% at 50% 0%, rgba(45,179,106,0.12) 0%, transparent 65%)",
          }}
          aria-hidden
        />
        <div
          ...
          style={{
            background: "linear-gradient(90deg, transparent, rgba(45,179,106,0.35), transparent)",
          }}
          aria-hidden
        />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              ...
              style={{
                ...
                color: "white",
                boxShadow: "0 4px 24px rgba(45,179,106,0.3)",
              }}
            >
      ...
      <section className="px-4 md:px-8 max-w-5xl mx-auto pb-16 md:pb-24">
        ...
        >
          <div
            ...
            style={{
              background: "radial-gradient(circle, rgba(45,179,106,0.25) 0%, transparent 65%)",
            }}
            aria-hidden
          />
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 p-8 md:p-12">
            <div>
              <div
                ...
                style={{
                  background: "rgba(45,179,106,0.2)",
                  color: "white",
              ...
              >
                ...
                <div className="px-3 pb-2">
                  <div
                    ...
                    style={{ background: "rgba(45,179,106,0.08)", border: `1px solid ${THEME.accentGreenBr}` }}
                  >
      ...
      <section className="px-4 md:px-8 max-w-3xl mx-auto pb-24 md:pb-32">
        ...
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 70% 60% at 50% 0%, rgba(45,179,106,0.08) 0%, transparent 70%)",
            }}
            aria-hidden
          />
