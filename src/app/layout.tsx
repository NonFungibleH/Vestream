...
const SITE_DESCRIPTION =
  "Track every token vesting unlock you're owed across 10 protocols and 8 chains. Push alerts when cliffs hit, one-tap claims, tax-ready exports. Free, no signup.";
