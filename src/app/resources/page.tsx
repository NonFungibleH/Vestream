...
const CATEGORY_COLORS: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  Guides:            { bg: "rgba(52,211,153,0.10)",  text: "#34d399", dot: "#3FA568" },
  "Market Analysis": { bg: "rgba(251,146,60,0.12)",  text: "#fb923c", dot: "#E89A3D" },
  Research:          { bg: "rgba(244,114,182,0.12)", text: "#f472b6", dot: "#D67099" },
};
