    ...
    return (
      <div className="rounded-2xl px-5 py-10 text-center"
        ...
        <p className="text-xs" style={{ color: "var(--preview-text-3)" }}>
          Wallet mode shows every indexed vesting position for one recipient – across all 11+ protocols.
        </p>
      </div>
    );
  }
  ...
  if (rows.length === 0) {
    return (
      <div className="rounded-2xl px-5 py-10 text-center"
        ...
        <p className="text-xs mt-1" style={{ color: "var(--preview-text-3)" }}>
          Track this wallet in your <Link href="/dashboard" className="underline">dashboard</Link> to live-scan all 11+ protocols.
        </p>
      </div>
    );
  }
