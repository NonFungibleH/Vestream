    ...
    <div className={`flex-1 flex flex-col min-w-0 overflow-hidden${dark ? " dark" : ""}`}>
        ...
        <header className="h-14 px-6 flex items-center justify-between flex-shrink-0"
          ...
          <div>
            ...
            <p className="text-[11px]" style={{ color: "var(--preview-text-3)" }}>
              Scan 10 protocols × 8 chains to find every active vesting for a wallet
            </p>
          </div>
        ...
        <main className="flex-1 overflow-y-auto px-6 py-6 space-y-5">
            ...
            <div className="flex items-start gap-4 mb-5">
              ...
              <div>
                ...
                <p className="text-[12px] leading-relaxed max-w-xl" style={{ color: "var(--preview-text-3)" }}>
                  Paste any wallet address. We hit all 10 protocols across 8 chains in parallel and return every active vesting, including streams not yet indexed by the search universe.
          ...
          {scanning && (
            <div className="rounded-2xl p-8 text-center"
              ...
              <p className="text-[11px]" style={{ color: "var(--preview-text-3)" }}>
                Checking 10 protocols × 8 chains. This may take 10–20 seconds.
              </p>
            </div>
          )}
