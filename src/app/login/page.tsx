      ...
      <div className="flex-1 flex items-center justify-center px-4 md:px-8 py-10 md:py-16">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-xs mt-5" style={{ color: "#8B8E92", lineHeight: 1.55 }}>
            Web dashboard is included with the <strong style={{ color: "#1CB8B8" }}>Pro</strong> plan ($9.99/mo or $74.99/year). <Link href="/#pricing" className="font-semibold underline" style={{ color: "#1CB8B8" }}>See plans</Link>.
          </p>
        </div>
      </div>
    </main>
