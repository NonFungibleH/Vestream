  ...
  if (state === "done" && apiKey) {
    return (
      <div className="flex flex-col gap-3 min-w-0 max-w-xs">
        <div className="rounded-xl p-3" style={{ background: "rgba(45,179,106,0.08)", border: "1px solid rgba(45,179,106,0.2)" }}>
        ...
        <button
          ...
          style={{
            background: copied ? "rgba(45,179,106,0.15)" : "rgba(45,179,106,0.1)",
            border: "1px solid rgba(45,179,106,0.25)",
            color: "#34d399",
          }}
        >
