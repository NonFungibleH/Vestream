  ...
  if (state === "done" && apiKey) {
    return (
      <div className="flex flex-col gap-3 min-w-0 max-w-xs">
        <div className="rounded-xl p-3" style={{ background: "rgba(63,165,104,0.08)", border: "1px solid rgba(63,165,104,0.2)" }}>
        ...
        <button
          ...
          style={{
            background: copied ? "rgba(63,165,104,0.15)" : "rgba(63,165,104,0.1)",
            border: "1px solid rgba(63,165,104,0.25)",
            color: "#34d399",
          }}
        >
