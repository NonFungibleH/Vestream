...
function IconStar()    { return <svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>; }
...
function IconBell()    { return <svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>; }
function IconWhale()   { return <svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round"><path d="M3 13c0-3 2-5 5-5h7l3-3v8c0 3-3 5-7 5H8l-2 3H3l1-4c-.7-1-1-2-1-4z"/><circle cx="13" cy="11" r="0.5" fill="currentColor"/></svg>; }
...
const NAV_ITEMS: Array<{
  ...
  { icon: <IconBell />,     label: "Alerts",          href: "/dashboard/alerts"             },
  { icon: <IconWhale />,    label: "Smart Money",     href: "/dashboard/smart-money"        },
  {
    icon:        <IconExport />,
    label:       "Tax Reports",
