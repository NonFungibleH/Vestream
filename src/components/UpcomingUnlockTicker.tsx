  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 4px 24px rgba(196,122,26,0.07)",
      }}
    >
      ...
      >
        <div className="flex items-center gap-2">
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full opacity-75" style={{ background: "#C47A1A" }} />
            <span className="relative inline-flex rounded-full h-2 w-2" style={{ background: "#C47A1A" }} />
          </span>
      ...
      {rows.length > 0 && (
        <div
          ...
          style={{
            ...
            background:   "rgba(196,122,26,0.02)",
            color:        "#64748b",
          }}
        >
          <span
    ...
    <div className="px-4 md:px-5 py-2.5 flex items-center gap-3 transition-colors hover:bg-slate-50/60">
      ...
      <div className="flex-shrink-0 text-right">
        <div
          ...
          style={{
            background: imminent ? "rgba(184,85,133,0.1)" : "rgba(196,122,26,0.1)",
            color:      imminent ? "#db2777"              : "#ea580c",
          }}
        >
          {imminent && (
            <span className="relative flex h-1.5 w-1.5">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full opacity-75" style={{ background: "#B85585" }} />
              <span className="relative inline-flex rounded-full h-1.5 w-1.5" style={{ background: "#B85585" }} />
            </span>
          )}
          in {ttl}
        </div>
