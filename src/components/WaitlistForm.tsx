    ...
    return (
      <div className="flex flex-col items-center gap-2">
        <div
          ...
          style={dark
            ? { background: "rgba(45,179,106,0.15)", border: "1px solid rgba(45,179,106,0.3)", color: "#6ee7b7" }
            : { background: "rgba(45,179,106,0.08)", border: "1px solid rgba(45,179,106,0.2)", color: "#059669" }
          }
        >
