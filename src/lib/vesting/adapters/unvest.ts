...
const SUBGRAPH_URLS: Record<SupportedChainId, string | undefined> = {
  ...
  [CHAIN_IDS.ZKSYNC]:         undefined,  // Unvest not deployed
  [CHAIN_IDS.BLAST]:          undefined,  // Unvest not deployed
  [CHAIN_IDS.BERACHAIN]:      undefined,  // Unvest not deployed  // Unvest has no Monad deployment
