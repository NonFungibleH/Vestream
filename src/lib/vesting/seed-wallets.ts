...
export const PINKSALE_SEED_WALLETS: Record<SupportedChainId, string[]> = {
  ...
  [CHAIN_IDS.MONAD]:     [],
  [CHAIN_IDS.ZKSYNC]:      [],  // Envio/Squid-indexed; no seed wallets needed
  [CHAIN_IDS.BLAST]:       [],  // Envio/Squid-indexed; no seed wallets needed
  [CHAIN_IDS.BERACHAIN]:   [],  // Envio/Squid-indexed; no seed wallets needed  // Sablier-only so far; Envio needs no seed wallets
