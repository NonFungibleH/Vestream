...
const articles: Article[] = [
  ...
  // ── SEO article: What Is Jupiter Lock? Solana Token Vesting Explained (2026) ──
  {
    slug:        "what-is-jupiter-lock-solana-token-vesting",
    title:       "What Is Jupiter Lock? Solana Token Vesting Explained (2026)",
    excerpt:     "Jupiter Lock is the token vesting tool from Jupiter on Solana. How its cliff-then-periodic schedule works, what the on-chain numbers show, and how to track a Jupiter Lock unlock.",
    publishedAt: "2026-09-15",
    updatedAt:   "2026-09-15",
    readingTime: "3 min read",
    category:    "Protocols",
    tags:        ["Jupiter Lock", "Jupiter", "Solana vesting", "token vesting", "token unlock", "JUP"],
    content: [
      { type: "p", html: "<strong>Jupiter Lock</strong> is the token locking and vesting tool from Jupiter, one of Solana's best-known trading platforms. Projects use it to lock team, investor and treasury tokens on a schedule anyone can inspect on-chain. Jupiter uses it for its own team: according to <a href=\"https://docs.jup.ag/user-docs/more/jup-token/tokenomics\" rel=\"noopener\" target=\"_blank\">Jupiter's JUP tokenomics documentation</a>, JUP team members are on \"a 1-year cliff followed by 3 years of linear vesting\", and \"team tokens vest onchain and can be viewed on Jupiter Lock.\"" },
      { type: "callout", emoji: "🔍", title: "In one line", body: "A Jupiter Lock escrow releases a lump sum at a cliff, then equal amounts at a fixed interval until the schedule ends. Each escrow is a public Solana account, so the schedule can be read directly rather than taken on trust." },
      { type: "h2", text: "How a Jupiter Lock schedule works" },
      { type: "p", html: "Every lock is a vesting escrow account created by the Jupiter Lock program. Reading the program's account layout, a schedule is defined by a small set of fields:" },
      { type: "ul", items: ["<strong>Cliff time:</strong> when the first tokens become available.", "<strong>Cliff unlock amount:</strong> the lump sum released at the cliff.", "<strong>Frequency:</strong> the interval between each later release.", "<strong>Amount per period</strong> and <strong>number of periods:</strong> how much unlocks at each interval, and how many intervals there are.", "<strong>Total claimed:</strong> how much the recipient has already withdrawn.", "<strong>Cancelled at:</strong> recorded if the escrow is cancelled."] },
      { type: "p", html: "The total allocation is therefore the cliff amount plus the per-period amount multiplied by the number of periods. Tokens that have unlocked stay in the escrow until the recipient claims them." },
      { type: "callout", emoji: "📐", title: "Worked example", body: "A 1,000,000-token allocation with a 250,000-token cliff, then 25,000 tokens every month for 30 months, releases 250,000 at the cliff and 25,000 each month after. It reaches the full 1,000,000 at the end of the thirtieth period." },
      { type: "h2", text: "Jupiter Lock by the numbers" },
      { type: "p", html: "As of 15 September 2026, Vestream's index of the Jupiter Lock program shows:" },
      { type: "table", headers: ["Metric", "Value"], rows: [["Vesting escrows indexed", "60,078"], ["Still active", "1,124"], ["Wallets with an active schedule", "549"], ["Tokens", "355"], ["Value still locked", "About $328 million"]] },
      { type: "p", html: "The gap between 60,078 escrows and 1,124 active ones is normal for a mature program: most schedules ever created have already run their course. Value is priced from on-chain market liquidity, and the large majority of it sits in tokens with markets deep enough to price with high confidence. Live figures are on the <a href=\"/protocols/jupiter-lock\">Jupiter Lock protocol page</a>." },
      { type: "callout", emoji: "📊", title: "About these figures", body: "Figures are a snapshot of Vestream's on-chain index taken on 15 September 2026. Live figures, updated daily, are on the protocol page linked below." },
      { type: "h2", text: "Why tracking Jupiter Lock is awkward" },
      { type: "p", html: "Jupiter Lock's interface is built around creating and managing locks. For a recipient the harder problem is different: seeing every schedule you hold across projects, knowing when the next period lands, and remembering to claim. A periodic schedule isn't one date to remember, it's a series of them." },
      { type: "h2", text: "How to track a Jupiter Lock unlock" },
      { type: "ol", items: ["<strong>Read the escrow on a Solana explorer.</strong> Accurate, but you have to work out the schedule from the raw fields yourself.", "<strong>Use the project's own claim page</strong>, if it has one. Convenient, but it only shows that one project.", "<strong><a href=\"/find-vestings\">Scan your wallet on Vestream</a>.</strong> It reads every Jupiter Lock escrow where you are the recipient, alongside other Solana and EVM vesting protocols, and lists each upcoming release."] },
      { type: "faq", items: [{"q": "Is Jupiter Lock only on Solana?", "a": "Yes. Jupiter Lock is a Solana program, so it locks SPL tokens on Solana."}, {"q": "What happens to unlocked tokens I haven't claimed?", "a": "They stay in the escrow until you claim them. Unlocking makes tokens available to you; it doesn't move them into your wallet."}, {"q": "Can a Jupiter Lock escrow be cancelled?", "a": "The program stores a cancellation time on each escrow, so cancellation is part of its design. Check the terms of the specific lock you hold."}, {"q": "How does Vestream get Jupiter Lock data?", "a": "It reads the escrow accounts directly from the Jupiter Lock program on Solana rather than relying on a third-party API."}] },
      { type: "h2", text: "Sources" },
      { type: "ul", items: ["<a href=\"https://docs.jup.ag/user-docs/more/jup-token/tokenomics\" rel=\"noopener\" target=\"_blank\">Jupiter's JUP tokenomics documentation</a>: JUP team vesting schedule on Jupiter Lock", "<a href=\"/protocols/jupiter-lock\">Vestream Jupiter Lock protocol page</a>: live on-chain figures"] },
    ],
  },
  // ── SEO article: What Is Magna? Token Vesting and Distribution Platform (2026) ──
  {
    slug:        "what-is-magna-token-vesting",
    title:       "What Is Magna? Token Vesting and Distribution Platform (2026)",
    excerpt:     "Magna runs vesting, airdrops and claim portals for token projects and was acquired by Kraken in 2026. How its Merkle-based vesting works, why allocations are hard to see on-chain, and how to track a Magna unlock.",
    publishedAt: "2026-09-15",
    updatedAt:   "2026-09-15",
    readingTime: "3 min read",
    category:    "Protocols",
    tags:        ["Magna", "Kraken", "token vesting", "token distribution", "claim portal", "Merkle vesting"],
    content: [
      { type: "p", html: "<strong>Magna</strong> is a token management platform. Projects use it to run vesting schedules, airdrops and allocations, often through a claim portal carrying their own branding. <a href=\"https://www.theblock.co/post/390358/kraken-buys-token-vesting-platform-magna-hit-peak-tvl-60-billion-in-2025\" rel=\"noopener\" target=\"_blank\">The Block</a> describes it as handling \"onchain and offchain vesting, white-label token claims, custody and escrow workflows.\" Kraken announced it had acquired Magna on 18 February 2026, and The Block reported that Magna \"reportedly hit a peak Total Value Locked of $60 billion in 2025.\"" },
      { type: "callout", emoji: "🔍", title: "In one line", body: "Magna escrows tokens in a contract for each distribution but keeps each person's allocation off-chain in a Merkle tree. Your schedule only becomes visible on-chain once you claim." },
      { type: "h2", text: "How Magna vesting works" },
      { type: "p", html: "For each distribution, Magna deploys a vester contract from a factory. The contract holds the tokens being distributed, but it doesn't store a list of recipients. It stores a <strong>Merkle root</strong>: a single fingerprint that commits to every allocation at once." },
      { type: "p", html: "Each recipient's allocation and unlock schedule lives in one leaf of that tree, held off-chain. To claim, a recipient submits their leaf with a proof, and the contract checks it against the root before releasing tokens." },
      { type: "p", html: "The design is efficient for large distributions, because thousands of allocations never have to be written on-chain. The trade-off is visibility: nobody can list the recipients or read an individual schedule from the chain alone." },
      { type: "h2", text: "What that means for tracking" },
      { type: "ul", items: ["<strong>Total value escrowed is visible</strong>, because the vester contract holds the tokens.", "<strong>Your full schedule becomes visible after your first claim</strong>, because the claim reveals your leaf.", "<strong>Allocations nobody has claimed yet are not visible on-chain at all.</strong>"] },
      { type: "p", html: "Vestream works within those limits. It reads the escrow balance of every Magna vester it finds, and when a recipient claims, it decodes their leaf to recover the full schedule. It cannot show an allocation that has never been claimed, so for a Magna distribution your project's claim portal stays the source of truth until your first claim." },
      { type: "h2", text: "Magna by the numbers" },
      { type: "p", html: "As of 15 September 2026, Vestream tracks Magna vester contracts on seven chains: Ethereum, Base, BNB Chain, Polygon, Arbitrum, Optimism and Avalanche. From recipients who have claimed at least once, the index holds:" },
      { type: "table", headers: ["Metric", "Value"], rows: [["Vesting schedules visible", "10,196"], ["Still active", "1,075"], ["Wallets with an active schedule", "1,008"]] },
      { type: "p", html: "Examples in the index include ATH on Ethereum with 76 recipient wallets, EDEN with 65 and PROMPT with 36. We don't quote one total value figure for Magna here: a large share of the escrowed supply is in tokens too thinly traded to price with confidence. Live figures are on the <a href=\"/protocols/magna\">Magna protocol page</a>." },
      { type: "callout", emoji: "📊", title: "About these figures", body: "Figures are a snapshot of Vestream's on-chain index taken on 15 September 2026. Live figures, updated daily, are on the protocol page linked below." },
      { type: "h2", text: "How to track a Magna unlock" },
      { type: "ol", items: ["<strong>Use your project's Magna claim portal.</strong> It knows your allocation even if you've never claimed.", "<strong><a href=\"/find-vestings\">Scan your wallet on Vestream</a></strong> once you've claimed at least once. It then shows your full Magna schedule next to vestings from other protocols."] },
      { type: "faq", items: [{"q": "Who owns Magna?", "a": "Kraken announced it had acquired Magna on 18 February 2026. Kraken's parent company is Payward."}, {"q": "Why can't I see my Magna allocation on a block explorer?", "a": "Magna keeps individual allocations off-chain in a Merkle tree and stores only a root on-chain. Your allocation becomes visible when you submit it with a proof to claim."}, {"q": "Does Vestream show Magna allocations I haven't claimed?", "a": "No. An allocation that has never been claimed isn't recorded on-chain, so no on-chain tracker can see it. Vestream shows your full schedule after your first claim."}, {"q": "Which chains does Vestream index Magna on?", "a": "Ethereum, Base, BNB Chain, Polygon, Arbitrum, Optimism and Avalanche."}] },
      { type: "h2", text: "Sources" },
      { type: "ul", items: ["<a href=\"https://www.theblock.co/post/390358/kraken-buys-token-vesting-platform-magna-hit-peak-tvl-60-billion-in-2025\" rel=\"noopener\" target=\"_blank\">The Block</a>: Kraken acquires Magna, product description and reported peak TVL", "<a href=\"/protocols/magna\">Vestream Magna protocol page</a>: live on-chain figures"] },
    ],
  },
  // ── SEO article: What Is Smithii? No-Code Token Vesting on Solana (2026) ──
  {
    slug:        "what-is-smithii-solana-token-vesting",
    title:       "What Is Smithii? No-Code Token Vesting on Solana (2026)",
    excerpt:     "Smithii lets Solana projects lock and vest tokens without writing a contract. How its vesting tool works, what it costs, what the on-chain data shows, and how to track a Smithii unlock.",
    publishedAt: "2026-09-15",
    updatedAt:   "2026-09-15",
    readingTime: "3 min read",
    category:    "Protocols",
    tags:        ["Smithii", "Solana vesting", "no-code token vesting", "token lock", "token unlock"],
    content: [
      { type: "p", html: "<strong>Smithii</strong> is a no-code toolkit for launching and managing tokens on Solana. Its vesting tool lets a project lock SPL tokens and release them on a schedule without deploying its own contract. <a href=\"https://tools.smithii.io/token-vesting/solana\" rel=\"noopener\" target=\"_blank\">Smithii's token vesting page</a> is direct about custody: \"The tokens are held by an audited smart contract. Not by Smithii.\"" },
      { type: "callout", emoji: "🔍", title: "In one line", body: "A project locks tokens for a recipient with either one unlock date or a series of dated cliffs. The lock can't be reversed, and the recipient claims each portion once it unlocks." },
      { type: "h2", text: "How Smithii vesting works" },
      { type: "p", html: "Smithii offers two ways to release tokens:" },
      { type: "ul", items: ["<strong>Single unlock:</strong> 100% of the tokens release on one date.", "<strong>Cliffs with unlocking periods:</strong> tokens release in portions across multiple dated cliffs."] },
      { type: "p", html: "Smithii describes locking as \"irreversible by design\": once tokens are in the contract they can't be withdrawn until the unlock conditions are met. Recipients claim each unlocked portion themselves, by connecting their wallet to a claim page Smithii generates." },
      { type: "h3", text: "What it costs" },
      { type: "p", html: "Smithii says locking tokens costs 0.3 SOL regardless of the amount, with an extra 0.1 SOL for schedules that unlock in periods. Check <a href=\"https://tools.smithii.io/token-vesting/solana\" rel=\"noopener\" target=\"_blank\">Smithii's token vesting page</a> for current pricing." },
      { type: "h3", text: "Security" },
      { type: "p", html: "Smithii states its vesting runs on an audited contract, and <a href=\"https://www.halborn.com/audits/smithii/vesting-1ae001\" rel=\"noopener\" target=\"_blank\">Halborn's audit of the Smithii vesting program</a> is published on Halborn's site." },
      { type: "h2", text: "Why Smithii allocations are easy to attribute" },
      { type: "p", html: "On-chain, many Smithii schedules name a single beneficiary wallet directly and keep their tokens in a dedicated vault account for that schedule. That makes an allocation straightforward to attribute to the person who holds it, unlike designs where individual allocations aren't stored on-chain. The program also supports Merkle-based distributions for larger recipient lists." },
      { type: "h2", text: "Smithii by the numbers" },
      { type: "p", html: "As of 15 September 2026, Vestream's index of the Smithii vesting program shows:" },
      { type: "table", headers: ["Metric", "Value"], rows: [["Vesting schedules indexed", "2,068"], ["Still active", "352"], ["Wallets with an active schedule", "331"], ["Tokens", "265"]] },
      { type: "p", html: "Most tokens vested through Smithii are small and thinly traded, so we don't quote a total value figure for it." },
      { type: "p", html: "One finding stands out. Measuring the balance left in each schedule's vault, about <strong>6 in 10 Smithii schedules that have finished vesting still hold tokens</strong>, some more than a year after they ended. The tokens are available; recipients simply haven't claimed them. Live figures are on the <a href=\"/protocols/smithii\">Smithii protocol page</a>." },
      { type: "callout", emoji: "📊", title: "About these figures", body: "Figures are a snapshot of Vestream's on-chain index taken on 15 September 2026. Live figures, updated daily, are on the protocol page linked below." },
      { type: "h2", text: "How to track a Smithii unlock" },
      { type: "ol", items: ["<strong>Use the Smithii claim page</strong> for the lock. It shows the portions due to your wallet.", "<strong><a href=\"/find-vestings\">Scan your wallet on Vestream</a>.</strong> It reads every Smithii schedule where you are the beneficiary, next to your other Solana and EVM vestings, and lists what's claimable now."] },
      { type: "faq", items: [{"q": "Can a Smithii lock be cancelled?", "a": "Smithii describes its locks as irreversible by design: tokens can't be withdrawn until the unlock conditions are met."}, {"q": "Do I have to claim my Smithii tokens?", "a": "Yes. Unlocked portions stay in the contract until you claim them through Smithii's claim page."}, {"q": "How much does Smithii vesting cost?", "a": "Smithii says 0.3 SOL to lock tokens regardless of amount, plus 0.1 SOL for schedules with unlocking periods. Check its site for current pricing."}, {"q": "Which chain is Smithii vesting on?", "a": "Smithii's token vesting tool is built for Solana."}] },
      { type: "h2", text: "Sources" },
      { type: "ul", items: ["<a href=\"https://tools.smithii.io/token-vesting/solana\" rel=\"noopener\" target=\"_blank\">Smithii's token vesting page</a>: schedule options, fees, custody and claiming", "<a href=\"https://www.halborn.com/audits/smithii/vesting-1ae001\" rel=\"noopener\" target=\"_blank\">Halborn's audit of the Smithii vesting program</a>", "<a href=\"/protocols/smithii\">Vestream Smithii protocol page</a>: live on-chain figures"] },
    ],
  },
  // ── SEO article: What Is HoodLock? Token Locking on Robinhood Chain (2026) ──
  {
    slug:        "what-is-hoodlock-robinhood-chain-token-locker",
    title:       "What Is HoodLock? Token Locking on Robinhood Chain (2026)",
    excerpt:     "HoodLock is a token and liquidity locker for Robinhood Chain. What it can lock, how its fee works, what the on-chain data shows, and how to track a HoodLock unlock.",
    publishedAt: "2026-09-15",
    updatedAt:   "2026-09-15",
    readingTime: "2 min read",
    category:    "Protocols",
    tags:        ["HoodLock", "Robinhood Chain", "token locker", "liquidity lock", "token unlock"],
    content: [
      { type: "p", html: "<strong>HoodLock</strong> is a locking service for Robinhood Chain, an Ethereum-compatible network. <a href=\"https://hoodlock.tech/docs\" rel=\"noopener\" target=\"_blank\">HoodLock's documentation</a> describes it as covering \"locking, burning and vesting tokens on Robinhood Chain.\" Projects use it to lock tokens or liquidity until a set date, as an on-chain signal that the supply can't be sold early." },
      { type: "callout", emoji: "🔍", title: "In one line", body: "A HoodLock lock holds a token amount until a chosen date. Once that date passes, the owner withdraws the full amount." },
      { type: "h2", text: "What HoodLock can lock" },
      { type: "ul", items: ["<strong>ERC-20 tokens</strong>, held until a date. Locks can be extended but not shortened.", "<strong>Liquidity pool tokens</strong> from v2-style pools.", "<strong>Vesting schedules</strong> with an optional cliff and linear release."] },
      { type: "h2", text: "How a HoodLock lock works" },
      { type: "p", html: "A lock records its owner, the token, the amount and an unlock time. When the unlock time passes, the owner withdraws the whole amount. Because everything releases at one moment, each lock behaves as a single cliff rather than a gradual schedule." },
      { type: "p", html: "HoodLock charges one flat fee in ETH when a lock is created. Its documentation says it takes no percentage of your tokens and withdrawals are free." },
      { type: "callout", emoji: "🔎", title: "What Vestream tracks", body: "Vestream currently indexes HoodLock's token locker contract. HoodLock's documentation also describes a vesting product with linear release; schedules from that product aren't included in the figures below." },
      { type: "h2", text: "HoodLock by the numbers" },
      { type: "p", html: "As of 15 September 2026, Vestream's index of the HoodLock locker shows:" },
      { type: "table", headers: ["Metric", "Value"], rows: [["Locks indexed", "396"], ["Still active", "251"], ["Wallets with an active lock", "189"], ["Tokens", "162"], ["Value still locked", "About $2.4 million"]] },
      { type: "p", html: "Almost all of that value sits in tokens with enough liquidity to price confidently. Live figures are on the <a href=\"/protocols/hoodlock\">HoodLock protocol page</a>." },
      { type: "callout", emoji: "📊", title: "About these figures", body: "Figures are a snapshot of Vestream's on-chain index taken on 15 September 2026. Live figures, updated daily, are on the protocol page linked below." },
      { type: "h2", text: "How to track a HoodLock unlock" },
      { type: "ol", items: ["<strong>Read the lock on the Robinhood Chain explorer.</strong> The lock's unlock time and status are public.", "<strong><a href=\"/find-vestings\">Scan your wallet on Vestream</a></strong>, or open a token's page, to see each HoodLock lock's unlock date and whether it has been withdrawn."] },
      { type: "faq", items: [{"q": "Can I withdraw a HoodLock lock early?", "a": "No. Locks can be extended but not shortened, and the tokens can be withdrawn once the unlock time passes."}, {"q": "Does HoodLock take a cut of my tokens?", "a": "HoodLock says it charges a single flat fee in ETH when the lock is created, with no percentage of your tokens and free withdrawals."}, {"q": "Is a HoodLock lock the same as vesting?", "a": "Not quite. A lock releases the whole amount at one date, while vesting releases tokens gradually. HoodLock's documentation describes both; Vestream's figures cover the locker."}, {"q": "What can HoodLock lock?", "a": "ERC-20 tokens and liquidity pool tokens from v2-style pools, on Robinhood Chain."}] },
      { type: "h2", text: "Sources" },
      { type: "ul", items: ["<a href=\"https://hoodlock.tech/docs\" rel=\"noopener\" target=\"_blank\">HoodLock's documentation</a>: what HoodLock locks, fees and withdrawals", "<a href=\"/protocols/hoodlock\">Vestream HoodLock protocol page</a>: live on-chain figures"] },
    ],
  },
  // ── SEO article: What Is Unvest? Milestone and Custom Token Vesting (2026) ──
  {
    slug:        "what-is-unvest-token-vesting",
    title:       "What Is Unvest? Milestone and Custom Token Vesting (2026)",
    excerpt:     "Unvest is a no-code platform for token vesting with cliffs, linear release and milestone unlocks, and allocations recipients can move between wallets. How it works, what the on-chain data shows, and how to track an Unvest unlock.",
    publishedAt: "2026-09-15",
    updatedAt:   "2026-09-15",
    readingTime: "2 min read",
    category:    "Protocols",
    tags:        ["Unvest", "token vesting", "milestone vesting", "vesting rounds", "token unlock"],
    content: [
      { type: "p", html: "<strong>Unvest</strong> is a no-code platform for token vesting, distribution and liquidity locks. Projects use it to set up vesting rounds for investors and teams. <a href=\"https://www.unvest.io/features/token-vesting\" rel=\"noopener\" target=\"_blank\">Unvest's token vesting page</a> puts it plainly: \"You don't need to write any code or burn precious developer hours, everything is point and click.\"" },
      { type: "callout", emoji: "🔍", title: "In one line", body: "A project creates a vesting round with its own release curve, adds recipients, and each recipient claims from a dashboard as tokens unlock." },
      { type: "h2", text: "How Unvest vesting works" },
      { type: "ul", items: ["<strong>Custom release curves:</strong> cliffs, linear vesting or milestone-based unlocks.", "<strong>Locked and unlocked in one go:</strong> part of an allocation can be claimable immediately while the rest vests.", "<strong>Adding recipients:</strong> type, paste or upload a CSV of addresses, including to rounds that already exist.", "<strong>Claiming:</strong> recipients use a claim dashboard to see their progress and claim tokens."] },
      { type: "h3", text: "Allocations can move between wallets" },
      { type: "p", html: "One detail sets Unvest apart: it says recipients can transfer locked allocations between wallets. A vesting position isn't necessarily stuck in the wallet it was issued to, so a tracker has to follow whoever holds it now." },
      { type: "h3", text: "What it costs" },
      { type: "p", html: "Unvest says its vesting service is free for projects, with paid plans for unlimited vesting rounds." },
      { type: "h2", text: "Unvest by the numbers" },
      { type: "p", html: "As of 15 September 2026, Vestream indexes Unvest on Ethereum, BNB Chain, Polygon, Base and Arbitrum. The index shows:" },
      { type: "table", headers: ["Metric", "Value"], rows: [["Vesting schedules indexed", "20,206"], ["Still active", "380"], ["Wallets with an active schedule", "322"], ["Tokens", "89"], ["Value still locked", "About $1.3 million"]] },
      { type: "p", html: "Most schedules in the index have already completed. Unvest lists support for more networks than the five indexed here. Live figures are on the <a href=\"/protocols/unvest\">Unvest protocol page</a>." },
      { type: "callout", emoji: "📊", title: "About these figures", body: "Figures are a snapshot of Vestream's on-chain index taken on 15 September 2026. Live figures, updated daily, are on the protocol page linked below." },
      { type: "h2", text: "How to track an Unvest unlock" },
      { type: "ol", items: ["<strong>Use the project's Unvest claim dashboard.</strong> It shows your progress for that round.", "<strong><a href=\"/find-vestings\">Scan your wallet on Vestream</a>.</strong> It reads Unvest holder balances for your wallet across the indexed chains and lists upcoming releases with your other vestings."] },
      { type: "faq", items: [{"q": "Can I transfer an Unvest allocation to another wallet?", "a": "Unvest says recipients can transfer locked allocations between wallets."}, {"q": "Does Unvest support milestone vesting?", "a": "Yes. Unvest lists milestone-based unlocks alongside cliffs and linear vesting."}, {"q": "Is Unvest free?", "a": "Unvest says vesting is free for projects, with paid plans for unlimited vesting rounds."}, {"q": "Which chains does Vestream index Unvest on?", "a": "Ethereum, BNB Chain, Polygon, Base and Arbitrum."}] },
      { type: "h2", text: "Sources" },
  ...
  // ── Article 7 ────────────────────────────────────────────────────────────────
  // ── SEO article: Why Token Prices Often Fall Before an Unlock, Not On It (2026) ──
  {
    slug:        "why-token-prices-fall-before-unlocks",
    title:       "Why Token Prices Often Fall Before an Unlock, Not On It (2026)",
    excerpt:     "Research across more than 16,000 token unlocks found most were followed by falling prices, with the decline usually starting weeks before the tokens released. Why that happens, which unlocks hit hardest, and how to read an unlock before it lands.",
    publishedAt: "2026-09-15",
    updatedAt:   "2026-09-15",
    readingTime: "6 min read",
    category:    "Guides",
    tags:        ["token unlock", "unlock price impact", "token vesting", "Keyrock", "supply", "circulating supply"],
    content: [
      { type: "p", html: "Most people picture a token unlock as a single day: tokens release, holders sell, the price drops. The research suggests something less obvious. The price pressure usually <strong>starts weeks earlier</strong>, and by the time tokens actually release, much of the move may already have happened." },
      { type: "callout", emoji: "⚠️", title: "Information, not financial advice", body: "This article explains how unlocks tend to affect markets. It doesn't tell you what to do with any position. An unlock is one input among many." },
      { type: "callout", emoji: "🔍", title: "The short version", body: "Unlock dates are public, so the market positions ahead of them. Research on more than 16,000 unlocks found roughly 90% were followed by negative price pressure, typically starting about 30 days before. Who receives the tokens, and how big the unlock is relative to what actually trades, matter more than the headline size." },
      { type: "h2", text: "What the research found" },
      { type: "p", html: "Keyrock, a crypto market maker, analysed more than 16,000 token unlocks in <a href=\"https://keyrock.com/from-locked-to-liquidity-what-16000-token-unlocks-teach-us/\" rel=\"noopener\" target=\"_blank\">From Locked to Liquidity: What 16,000+ Token Unlocks Teach Us</a>. As reported by <a href=\"https://crypto.news/token-unlocks-almost-always-negative-for-price-keyrocks-study-reveals/\" rel=\"noopener\" target=\"_blank\">crypto.news</a> and <a href=\"https://www.chaincatcher.com/en/article/2155623\" rel=\"noopener\" target=\"_blank\">ChainCatcher</a>, its main findings were:" },
      { type: "ul", items: ["About 90% of unlock events resulted in price declines.", "Prices began to decline around 30 days before the unlock.", "Team unlocks were the most disruptive, investor unlocks were more controlled, and ecosystem unlocks were the gentlest.", "Large unlocks, above 5% of supply, triggered volatility immediately, while frequent small unlocks applied continuous pressure.", "Around $600 million of tokens enter circulation through unlocks every week."] },
      { type: "p", html: "Keyrock's own report page wasn't accessible when this article was researched, so these figures are cited from that coverage." },
      { type: "h2", text: "Why the move starts before the unlock" },
      { type: "p", html: "The core reason is simple: the date is public. Vesting schedules sit in smart contracts and on unlock calendars, so everyone can see an unlock coming. ChainCatcher's summary of the Keyrock report attributes the early decline to two groups: \"Prices begin to decline 30 days before the unlock, primarily driven by retail expectations and institutional investors' hedging strategies.\"" },
      { type: "ul", items: ["<strong>Holders anticipating selling</strong> sell first, so they aren't selling into everyone else later.", "<strong>Institutional holders</strong> hedge their exposure ahead of the release rather than waiting for it."] },
      { type: "p", html: "When enough of the market acts early, the selling that everyone expected on unlock day gets spread across the weeks before it. That's why checking a token's unlock only on the day tends to be too late to be useful." },
      { type: "h2", text: "Not all unlocks are equal" },
      { type: "h3", text: "Who receives the tokens" },
      { type: "p", html: "ChainCatcher's summary describes team unlocks as \"the most disruptive due to a lack of coordination, leading to significant drops from individual sell-offs.\" Many individuals, each deciding separately, can sell into the open market at once." },
      { type: "p", html: "Investor unlocks are \"usually more controllable, as they employ complex hedging strategies\", and crypto.news notes investors often sell over the counter, which keeps some of that supply off the public order book. Ecosystem unlocks, which fund grants and development, are described as contributing to long-term stability." },
      { type: "h3", text: "How big it is compared with what actually trades" },
      { type: "p", html: "The headline number of tokens unlocking tells you little on its own. Two comparisons are more useful:" },
      { type: "ul", items: ["<strong>Against circulating supply</strong>, not total supply. Total supply includes tokens that may not reach the market for years.", "<strong>Against daily trading volume.</strong> Vestream calls this the <em>absorption ratio</em>: the unlock's value divided by the token's 24-hour trading volume. Above 1 means the unlock is worth more than a full day of trading."] },
      { type: "p", html: "Vestream also shows each unlock as a share of market cap, meaning how much of the token's total value is hitting the market at once." },
      { type: "h3", text: "One cliff or a steady drip" },
      { type: "p", html: "Keyrock's findings split by shape. A large one-off unlock, above 5% of supply, tends to spark volatility straight away. A steady run of small monthly unlocks looks harmless in isolation but applies pressure every single period. For more on how unlock frequency shapes behaviour, see <a href=\"/resources/vesting-unlock-frequency-investor-psychology\">how unlock cadence shapes investor psychology</a>." },
      { type: "h2", text: "A caution about the numbers" },
      { type: "p", html: "Ratios are only as good as the data behind them, and trading volume is where they break most easily. In September 2026, Vestream's page for Movement (MOVE) flagged a small upcoming unlock, worth about $14,800, as high sell-pressure risk. The absorption ratio was close to 600×. The reason was the denominator: MOVE's Ethereum DEX pairs were doing only tens of dollars of daily volume, so almost none of its trading happened where the ratio was measuring it." },
      { type: "p", html: "The lesson generalises. Before trusting any unlock-to-volume ratio, check where the token actually trades. A token that trades mostly away from the venues being measured will look far riskier than it is." },
      { type: "h2", text: "A real example: Falcon Finance" },
      { type: "p", html: "On 14 September 2026, Falcon Finance (FF) released 9.56 million FF from Sablier vesting contracts, worth about $1.3 million at the time. FF fell around 10% that day while Bitcoin rose about 2%, so the move wasn't simply the wider market. FF has unlocked at least monthly since May, and twice a month since July. At the time of writing, its next large tranche is 21.9 million FF on 1 October 2026, worth about $2.9 million." },
      { type: "p", html: "It's worth being precise about what this shows. The unlock and the fall happened on the same day, but that's correlation, not proof. That tranche was small relative to FF's supply, and a single day's move has many possible causes. The more useful point is the schedule itself: a recurring pattern like FF's is visible weeks in advance to anyone looking." },
      { type: "h2", text: "How to read an unlock before it lands" },
      { type: "ol", items: ["<strong>Find the date and size</strong>, in tokens and in dollars.", "<strong>Compare it with circulating supply</strong>, not total supply.", "<strong>Identify who receives it:</strong> team, investors or ecosystem.", "<strong>Compare it with daily volume</strong>, and check where the token actually trades before trusting the ratio.", "<strong>Look 30 days ahead</strong>, not only at the next date. Several smaller unlocks can add up.", "<strong>Check the pattern:</strong> a one-off cliff or a recurring schedule."] },
      { type: "p", html: "For building a fuller estimate, see <a href=\"/resources/estimating-token-unlock-price-impact\">how to estimate the price impact of a token unlock</a>. To find upcoming dates, see the <a href=\"/unlocks\">unlock calendar</a>." },
      { type: "h2", text: "If you're the one receiving tokens" },
      { type: "p", html: "The date matters for a different reason if the tokens are yours: you have to claim them, and many people don't. Measuring vault balances on the Smithii vesting program, about 6 in 10 schedules that had finished vesting still held unclaimed tokens, some more than a year after they ended. In the UK the unlock date can also decide when you're taxed, which is covered in <a href=\"/resources/uk-tax-vesting-tokens-vest-or-claim\">UK tax on vesting tokens</a>." },
      { type: "faq", items: [{"q": "Do token prices always fall before an unlock?", "a": "No. Keyrock's analysis found about 90% of unlocks were followed by price declines, which means roughly one in ten weren't. Recipient type, size relative to liquidity and wider market conditions all matter."}, {"q": "How far ahead of an unlock does the effect start?", "a": "The Keyrock research, as reported, found prices began declining around 30 days before the unlock."}, {"q": "Which unlocks tend to have the biggest effect?", "a": "Team unlocks, according to the research, because many uncoordinated individuals can sell at once. Large unlocks relative to circulating supply and daily volume also matter more than the raw token count."}, {"q": "What is an absorption ratio?", "a": "Vestream's absorption ratio is an unlock's value divided by the token's 24-hour trading volume. Above 1 means the unlock is worth more than a full day of trading. It can be misleading for tokens that mostly trade on venues the volume figure doesn't capture."}, {"q": "Should I sell before a token unlock?", "a": "This article doesn't make that call. An unlock is one input among many, and a well-known one may already be reflected in the price by the time it arrives."}] },
      { type: "h2", text: "Sources" },
      { type: "ul", items: ["<a href=\"https://keyrock.com/from-locked-to-liquidity-what-16000-token-unlocks-teach-us/\" rel=\"noopener\" target=\"_blank\">From Locked to Liquidity: What 16,000+ Token Unlocks Teach Us</a> (Keyrock)", "<a href=\"https://crypto.news/token-unlocks-almost-always-negative-for-price-keyrocks-study-reveals/\" rel=\"noopener\" target=\"_blank\">crypto.news</a>: coverage of the Keyrock study, including recipient-type findings", "<a href=\"https://www.chaincatcher.com/en/article/2155623\" rel=\"noopener\" target=\"_blank\">ChainCatcher</a>: coverage of the Keyrock study, including timing and size findings", "Vestream on-chain index: Falcon Finance, Movement and Smithii figures, September 2026"] },
    ],
  },
  {
  ...
  // ── Article 24 ───────────────────────────────────────────────────────────────
  // ── SEO article: UK tax on vesting tokens (targets "uk crypto tax vesting",
  //    "taxed at vest or claim") — every legal claim cited to an HMRC manual page ──
  {
    slug: "uk-tax-vesting-tokens-vest-or-claim",
    title: "UK Tax on Vesting Tokens: Taxed When They Vest or When You Claim? (2026)",
    excerpt: "For UK recipients, the tax point on vesting tokens is usually when the tokens become yours, not when you click claim. What HMRC's guidance actually says, where it runs out, and what it means for your 2025–26 return.",
    publishedAt: "2026-09-15",
    updatedAt: "2026-09-15",
    readingTime: "8 min read",
    category: "Taxes",
    tags: ["UK tax", "HMRC", "vesting tokens", "crypto tax UK", "Capital Gains Tax", "Self Assessment", "cost basis", "token vesting"],
    content: [
      { type: "p", html: "If you receive tokens on a vesting schedule and you're UK tax resident, one question decides your numbers: are you taxed when the tokens <strong>vest</strong>, or when you <strong>claim</strong> them into your wallet? It matters because token prices move. A tranche worth £10,000 on the day it unlocked might be worth £4,000 by the time you claim it, or £25,000." },
      { type: "callout", emoji: "⚠️", title: "General information, not tax advice", body: "HMRC has not published guidance written specifically for tokens released by on-chain vesting contracts. This article sets out what HMRC's manuals do say, cites each source, and is explicit about where that guidance runs out. Your own facts decide your position, so confirm it with a UK tax adviser before you file." },
      { type: "callout", emoji: "🔍", title: "The short version", body: "For most UK recipients paid in tokens for work, the likely tax point is when the tokens are provided to you. For on-chain vesting that usually means the unlock date, not the claim date, and claiming later is typically not a second income event. Tokens you bought, rather than earned, are generally a Capital Gains Tax matter instead." },
      { type: "h2", text: "First, why you got the tokens decides which tax applies" },
      { type: "p", html: "HMRC has no single rule for \"vesting tokens\". The treatment follows why you received them, and three situations cover almost everyone." },
      { type: "table", headers: ["How you got the tokens", "Main tax", "What HMRC's guidance says"], rows: [["Paid for work: a team, employee, contributor or advisor allocation", "Income Tax and National Insurance on the value, then Capital Gains Tax when you dispose of them", "Tokens received as employment income count as money's worth and are subject to Income Tax and National Insurance on their value (CRYPTO21100)"], ["Bought: a seed, presale or SAFT allocation that vests", "Usually no Income Tax, because you paid for them. Capital Gains Tax when you dispose of them", "Treated under HMRC's Capital Gains Tax rules for cryptoassets, using what you paid as your cost"], ["Airdropped, or a community allocation", "Depends on whether you did something in return", "Income Tax may not apply if you received them without doing anything in return, but does apply if they were provided for a service. Capital Gains Tax can apply when you dispose of them either way (CRYPTO21250)"]] },
      { type: "p", html: "Sources: <a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto21100\" rel=\"noopener\" target=\"_blank\">CRYPTO21100</a>, <a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto21250\" rel=\"noopener\" target=\"_blank\">CRYPTO21250</a>, <a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto22000\" rel=\"noopener\" target=\"_blank\">HMRC's Capital Gains Tax guidance for cryptoassets</a>." },
      { type: "h2", text: "So when are you taxed: at vest or at claim?" },
      { type: "p", html: "This is where HMRC's crypto guidance goes quiet. Nothing in its Cryptoassets Manual deals with tokens that sit in a vesting contract until you withdraw them. So the answer has to come from the general employment income rules, and those point fairly clearly in one direction." },
      { type: "p", html: "Tokens paid for work are <em>money's worth</em>, not money. HMRC's Employment Income Manual says money's worth is taxed in \"the year the benefit is provided\" under section 19(4) of ITEPA 2003 (<a href=\"https://www.gov.uk/hmrc-internal-manuals/employment-income-manual/eim42210\" rel=\"noopener\" target=\"_blank\">EIM42210</a>). So the real question is: when have the tokens been provided to you?" },
      { type: "p", html: "For most on-chain vesting, the natural answer is the unlock date. At that moment the tranche is yours. What remains is sending a transaction to move tokens you already own, which is administration rather than a new payment." },
      { type: "p", html: "HMRC's treatment of restricted stock units points the same way. In its RSU example the employee is charged \"on the market value of the shares received at vesting\" (<a href=\"https://www.gov.uk/hmrc-internal-manuals/employment-related-securities/ersm20194\" rel=\"noopener\" target=\"_blank\">ERSM20194</a>), not at grant and not when they later sell. Tokens are not shares, so this is an analogy rather than a rule HMRC has applied to tokens. It is, however, the closest official guidance on vesting there is." },
      { type: "callout", emoji: "📅", title: "What that means in practice", body: "Say a tranche unlocked on 10 March 2026 and you claimed it on 20 May 2026. The likely tax point is 10 March. That puts the income in the 2025–26 tax year, valued at the sterling price on 10 March, even though you only moved the tokens in the 2026–27 tax year." },
      { type: "h3", text: "When the answer might be different" },
      { type: "ul", items: ["<strong>Unlocked tokens can still be taken back.</strong> If the sender can still reclaim tokens that have unlocked until you claim them, those tokens arguably haven't been fully provided until you do. Check what your particular contract allows.", "<strong>There's a condition to meet at claim.</strong> If claiming needs more than sending a transaction, such as still being employed on the claim date, entitlement may only arise once that condition is met.", "<strong>The tokens come from a third party.</strong> If a foundation or another company provides the tokens rather than your employer, Part 7A of ITEPA 2003 can create an Income Tax charge (<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto42300\" rel=\"noopener\" target=\"_blank\">CRYPTO42300</a>). The timing question is the same, but the reporting route can differ.", "<strong>You weren't UK resident for the whole vesting period.</strong> Vesting that spans a move to or from the UK raises questions that need an adviser."] },
      { type: "h2", text: "How the income gets reported" },
      { type: "p", html: "How you report depends on whether HMRC treats the tokens as <em>readily convertible assets</em>. It considers exchange tokens generally will be, where trading arrangements exist for them." },
      { type: "ul", items: ["<strong>Readily convertible, the usual case:</strong> your employer should account for Income Tax and National Insurance through PAYE, using its best estimate of the value (<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto21100\" rel=\"noopener\" target=\"_blank\">CRYPTO21100</a>). Check your payslips and P60 before assuming you owe more.", "<strong>Not readily convertible:</strong> your employer doesn't run PAYE on them and handles Class 1A National Insurance instead. You declare the value on the employment pages of your Self Assessment return and pay the Income Tax yourself (<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto42250\" rel=\"noopener\" target=\"_blank\">CRYPTO42250</a>)."] },
      { type: "p", html: "Either way, values have to be in pounds sterling at the time the income arose. HMRC's guidance refers to the \"pound sterling value (at the time of receipt)\" (<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto21200\" rel=\"noopener\" target=\"_blank\">CRYPTO21200</a>). If your records are in US dollars, convert at the rate on that day, not at today's rate." },
      { type: "h2", text: "Then Capital Gains Tax when you dispose of them" },
      { type: "p", html: "Income Tax covers the tokens arriving. Any change in value after that, up to the point you dispose of them, is a matter for Capital Gains Tax." },
      { type: "p", html: "The value you were taxed on as income should form your starting cost. For employment-related shares and securities, HMRC's stated aim is \"to prevent the same value difference being charged to both Income Tax and Capital Gains Tax\" (<a href=\"https://www.gov.uk/hmrc-internal-manuals/capital-gains-manual/cg56321a\" rel=\"noopener\" target=\"_blank\">CG56321A</a>). That page is written for shares and securities rather than tokens, so confirm how your tokens are treated with an adviser, but not being taxed twice on the same value is the principle behind it." },
      { type: "p", html: "Three matching rules then decide which cost applies when you dispose of tokens (<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto22200\" rel=\"noopener\" target=\"_blank\">CRYPTO22200</a>):" },
      { type: "ul", items: ["<strong>Pooling:</strong> tokens of the same type go into one pool with an average cost, called a section 104 pool, rather than being tracked lot by lot.", "<strong>Same-day rule:</strong> tokens acquired and disposed of on the same day are matched against each other first.", "<strong>30-day rule:</strong> if you dispose of tokens and acquire more of the same type within the next 30 days, the new tokens are matched to that disposal instead of the pool."] },
      { type: "p", html: "The Capital Gains Tax annual exempt amount is currently £3,000. Check gov.uk for the figure for the year you're filing." },
      { type: "h2", text: "Why the vest-or-claim date changes your bill" },
      { type: "p", html: "Using the wrong date doesn't just move income between tax years. It changes how much income you record, and that figure then becomes your cost for Capital Gains Tax. Here is one tranche of 10,000 tokens, later sold for £0.80 each, recorded both ways." },
      { type: "table", headers: ["", "Unlock date basis", "Claim date basis"], rows: [["Price on that date", "£1.20", "£0.50"], ["Income recorded", "£12,000", "£5,000"], ["Tax year", "2025–26", "2026–27"], ["Later sold for £8,000", "£4,000 capital loss", "£3,000 capital gain"]] },
      { type: "p", html: "Same tokens, same sale. One basis records £12,000 of income and a £4,000 loss, the other £5,000 of income and a £3,000 gain. That is why the date matters far more than it first appears." },
      { type: "h2", text: "Finding your unlock dates and values" },
      { type: "p", html: "In practice the hard part isn't the rule, it's the records. Vesting contracts don't send statements, and exchange history won't show tokens that moved straight from a contract into your wallet. For every tranche you need the unlock date, the amount, the sterling value on that date, and separately the date you claimed it." },
      { type: "p", html: "Vestream reads this directly from the chain across the major vesting protocols. Its tax tool lets you switch between <strong>Unlock basis</strong> and <strong>Claim basis</strong>, shows both side by side for every tranche, and flags any token it couldn't price so you can enter a value yourself. You can <a href=\"/find-vestings\">scan a wallet free</a>, and the full income statement and exports are part of <a href=\"/pricing\">Vestream Pro</a>. For how the US and other countries treat vesting, see our <a href=\"/resources/token-vesting-tax-guide\">token vesting tax guide</a>." },
      { type: "h2", text: "Key dates for the 2025–26 tax year" },
      { type: "ul", items: ["Tax year: 6 April 2025 to 5 April 2026", "Paper return deadline: 31 October 2026", "Online return and payment deadline: 31 January 2027"] },
      { type: "faq", items: [{"q": "Do I pay tax on vested tokens I haven't claimed yet?", "a": "If you received them for work, they have unlocked and they can't be taken back, you are likely taxable on them in the tax year they unlocked, even while they sit in the vesting contract. HMRC hasn't issued guidance specific to tokens on this, so confirm your position with an adviser."}, {"q": "Is claiming my tokens a taxable event?", "a": "Usually not in itself. If the tokens were already yours at unlock, claiming moves an asset you own rather than paying you something new. Disposing of the tokens later is what can bring Capital Gains Tax into play."}, {"q": "Are vesting tokens from a presale taxed as income?", "a": "Generally not, because you paid for them. They are a Capital Gains Tax matter when you dispose of them, using what you paid as your cost."}, {"q": "What value do I use for tokens with no market price?", "a": "HMRC expects a sterling value at the time of receipt, and for employment tokens your employer works from its best estimate of the value. Where there's no market price, you or your adviser need a reasonable valuation, and you should keep a record of how you reached it."}, {"q": "Does National Insurance apply to vesting tokens?", "a": "For tokens received as employment income, yes. HMRC treats them as subject to Income Tax and National Insurance on their value. Where they are readily convertible that runs through PAYE, and where they are not, your employer handles Class 1A National Insurance."}, {"q": "What's the deadline to report tokens that vested in 2025–26?", "a": "31 January 2027 for an online Self Assessment return and for paying what you owe. Paper returns are due by 31 October 2026."}] },
      { type: "h2", text: "Sources" },
      { type: "ul", items: ["<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto21100\" rel=\"noopener\" target=\"_blank\">CRYPTO21100</a>: earnings from employment, readily convertible assets", "<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto42250\" rel=\"noopener\" target=\"_blank\">CRYPTO42250</a>: exchange tokens that are not readily convertible assets", "<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto42300\" rel=\"noopener\" target=\"_blank\">CRYPTO42300</a>: employment income provided through third parties", "<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto21250\" rel=\"noopener\" target=\"_blank\">CRYPTO21250</a>: airdrops", "<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto21200\" rel=\"noopener\" target=\"_blank\">CRYPTO21200</a>: staking, sterling value at the time of receipt", "<a href=\"https://www.gov.uk/hmrc-internal-manuals/cryptoassets-manual/crypto22200\" rel=\"noopener\" target=\"_blank\">CRYPTO22200</a>: pooling, same-day and 30-day rules", "<a href=\"https://www.gov.uk/hmrc-internal-manuals/employment-income-manual/eim42210\" rel=\"noopener\" target=\"_blank\">EIM42210</a>: basis of assessment for money's worth", "<a href=\"https://www.gov.uk/hmrc-internal-manuals/employment-related-securities/ersm20194\" rel=\"noopener\" target=\"_blank\">ERSM20194</a>: restricted stock units taxed at vesting", "<a href=\"https://www.gov.uk/hmrc-internal-manuals/capital-gains-manual/cg56321a\" rel=\"noopener\" target=\"_blank\">CG56321A</a>: interaction between employment income and Capital Gains Tax", "<a href=\"https://www.gov.uk/self-assessment-tax-returns/deadlines\" rel=\"noopener\" target=\"_blank\">GOV.UK: Self Assessment deadlines</a>", "<a href=\"https://www.gov.uk/capital-gains-tax/allowances\" rel=\"noopener\" target=\"_blank\">GOV.UK: Capital Gains Tax allowances</a>"] },
      { type: "callout", emoji: "⚠️", title: "Check this against your own situation", body: "Tax law and HMRC guidance change, and HMRC has not directly settled the position on tokens released from vesting contracts. Use this article to understand the questions and the records you need, then confirm the answer with a UK tax adviser. Last reviewed 15 September 2026." },
    ],
  },
  {
