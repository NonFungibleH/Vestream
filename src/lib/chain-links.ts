...
export function blockExplorerUrl(chainId: number, address: string): string | null {
  ...
  switch (chainId) {
    ...
    case 4663:     return `https://robinhoodchain.blockscout.com/token/${addr}`;
...
export function blockExplorerAddressUrl(chainId: number, address: string): string | null {
  ...
  switch (chainId) {
    ...
    case 4663:     return `https://robinhoodchain.blockscout.com/address/${addr}`;
