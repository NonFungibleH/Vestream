...
export const PROTOCOLS: Record<string, ProtocolMeta> = {
  sablier: {
    ...
    color: "#E89A3D",
    bg:    "rgba(232,154,61,0.08)",
    border:"rgba(232,154,61,0.22)",
  ...
  "team-finance": {
    ...
    color: "#3FA568",
    bg:    "rgba(63,165,104,0.08)",
    border:"rgba(63,165,104,0.22)",
    chainIds: [CHAIN_IDS.ETHEREUM, CHAIN_IDS.BASE, CHAIN_IDS.BSC, CHAIN_IDS.POLYGON],
  ...
  uncx: {
    ...
    color: "#5577A8",
    bg:    "rgba(85,119,168,0.08)",
    border:"rgba(85,119,168,0.22)",
    chainIds: [CHAIN_IDS.ETHEREUM, CHAIN_IDS.BASE, CHAIN_IDS.BSC, CHAIN_IDS.POLYGON],
  ...
  superfluid: {
    ...
    color: "#3CA386",
    bg:    "rgba(60,163,134,0.08)",
    border:"rgba(60,163,134,0.22)",
    chainIds: [CHAIN_IDS.ETHEREUM, CHAIN_IDS.BASE, CHAIN_IDS.BSC, CHAIN_IDS.POLYGON],
  ...
  pinksale: {
    ...
    color: "#D67099",
    bg:    "rgba(214,112,153,0.08)",
    border:"rgba(214,112,153,0.22)",
    chainIds: [CHAIN_IDS.ETHEREUM, CHAIN_IDS.BASE, CHAIN_IDS.BSC, CHAIN_IDS.POLYGON],
  ...
  streamflow: {
    ...
    color: "#8DD3AB",         // Solana green
    bg:    "rgba(141,211,171,0.08)",
    border:"rgba(141,211,171,0.24)",
  ...
  "jupiter-lock": {
    ...
    color: "#E8C46B",        // Jupiter orange-gold
    bg:    "rgba(232,196,107,0.08)",
    border:"rgba(232,196,107,0.26)",
    chainIds: [CHAIN_IDS.SOLANA],
