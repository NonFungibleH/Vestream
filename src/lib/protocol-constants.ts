...
export const PROTOCOLS: Record<string, ProtocolMeta> = {
  ...
  hedgey: {
    ...
    color: "#6E5DB8",
    bg:    "rgba(110,93,184,0.08)",
    border:"rgba(110,93,184,0.22)",
    chainIds: [CHAIN_IDS.ETHEREUM, CHAIN_IDS.BASE, CHAIN_IDS.BSC, CHAIN_IDS.POLYGON],
  ...
  superfluid: {
    ...
    color: "#1F7A64",
    bg:    "rgba(31,122,100,0.08)",
    border:"rgba(31,122,100,0.22)",
    chainIds: [CHAIN_IDS.ETHEREUM, CHAIN_IDS.BASE, CHAIN_IDS.BSC, CHAIN_IDS.POLYGON],
  ...
  pinksale: {
    ...
    color: "#B85585",
    bg:    "rgba(184,85,133,0.08)",
    border:"rgba(184,85,133,0.22)",
    chainIds: [CHAIN_IDS.ETHEREUM, CHAIN_IDS.BASE, CHAIN_IDS.BSC, CHAIN_IDS.POLYGON],
  ...
  streamflow: {
    ...
    color: "#7DB89A",         // Solana green
    bg:    "rgba(125,184,154,0.08)",
    border:"rgba(125,184,154,0.24)",
  ...
  "jupiter-lock": {
    ...
    color: "#C4A04A",        // Jupiter orange-gold
    bg:    "rgba(196,160,74,0.08)",
    border:"rgba(196,160,74,0.26)",
    chainIds: [CHAIN_IDS.SOLANA],
